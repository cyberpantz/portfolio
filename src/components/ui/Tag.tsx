...
export function Tag({ label, tone = 'accent' }: TagProps) {
  if (tone === 'gray') {
    return (
      <span className="inline-flex px-2 py-0.5 rounded-xs border border-rule-strong bg-ink-surface
  ...
  return (
    <span className="inline-flex px-2 py-0.5 rounded-xs border border-accent/30 bg-accent/10
